...
public final class VecUtils {
    ...
    public static Vec3 calculateBlockCenter(World world, BlockPos pos) {
        ...
        AxisAlignedBB shape = b.getBlock().getCollisionBoundingBox(world, pos, b);
        if (shape == null) {
            return getBlockPosCenter(pos);
        }
        double xDiff = (shape.minX + shape.maxX) / 2;
        double yDiff = (shape.minY + shape.maxY) / 2;
        double zDiff = (shape.minZ + shape.maxZ) / 2;
