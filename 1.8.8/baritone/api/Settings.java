...
public final class Settings {
    ...
    public final Setting<List<Item>> acceptableThrowawayItems = new Setting<>(new ArrayList<>(Arrays.asList(
            (new ItemStack(Blocks.dirt).getItem()),
            (new ItemStack(Blocks.cobblestone).getItem()),
            (new ItemStack(Blocks.netherrack).getItem()),
     ...
     * {@link Setting#value};
     */
    public final Setting<Consumer<String>> logger = new Setting<>(Minecraft.getMinecraft().ingameGUI.getChatGUI()::addToSentMessages);
